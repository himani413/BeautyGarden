         ...
         if(empty($buyerFirstName)){
            ...
            if($paymentMode=='Card-payment'){
               ...
               if(empty($cardType)){
                ...
                $sql = "INSERT INTO paymentdetails (first_name,last_name,payment_type,usraddress,city,province,zipcode,itemType,no_of_products,user_email)VALUES ('".$buyerFirstName."', '".$buyerLastName."', '".$paymentMode."', '".$buyerLivingAddress."', '".$buyerLivingCity."','".$buyerLivingProvince."','".$buyerZipCode."','".$product."','".$no_of_items."','".$email."')";
