...
<body>
    ...
    <div class="category">
                        <div class="category-name2">Our Team</div>
                            ...
                            <div class="item-col">
                                <div class="item">
                                    <img src="Images/a.jpg" alt=".." height="200px" width="200px" >
                                    <div class="description">
                                    <br>
                                    <h4>Sivananthanathan Apisathan</h4>
                                    <p>apisathan2000@gmail.com</p>
                                    </div>
                                </div>
                            </div>
                            <div class="item-col">
                               <div class="item">
                                    ...
                                    <br>
                                    <h3>Isuru Sasanga</h3>
                                    <p>isurusasanga1999@gmail.com</p>
                                    </div>
                                </div>
                            </div>
                            <div class="item-col">
                               <div class="item">
                                    <img src="Images/h.jpg" alt=".." height="200px" width="200px">
                                    <div class="description">
                                    <br>
                                    <h4>Himani Perera</h4>
                                    <p>himani413@outlook.com</p>
                                    </div>
                                </div>
                            </div>
                            <div class="item-col">
                                <div class="item">
                                    <img src="Images/m.jpg" alt=".." height="200px" width="200px">
                                    <div class="description">
                                    <br>
                                    <h4>Masith jayarathna</h4>
                                    <p>pramudithajayarathna@gmail.com</p>
                                    </div>
                                </div>
                            </div>
                            <div class="item-col">
                               <div class="item">
                                    <img src="Images/t.jpg" alt=".." height="200px" width="200px">
                                    <div class="description">
                                    <br>
                                    <h4>Thakshila Bandara</h4>
                                    <p>thakshiladb2000@gmail.com</p>
                                    </div>
                                </div>
                            </div>
                            <div class="item-col">
                                <div class="item">
                                    <img src="Images/d.jpg" alt=".." height="200px" width="200px">
                                    <div class="description">
                                    <br>
                                    <h4>Dinuka Ekanayake</h4>
                                    <p>dinukaekanayaka18@gmail.com</p>
                                    </div>
                                </div>
                            </div>
                        </div>
